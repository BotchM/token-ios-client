...
- (void)_presentAvatarMenu
{
    ...
    MenuSheetButtonItemView *galleryItem = [[MenuSheetButtonItemView alloc] initWithTitle:TGLocalized(@"Common.ChoosePhoto") type:MenuSheetButtonTypeDefault action:^
    {
        __strong TGMediaAvatarMenuMixin *strongSelf = weakSelf;
        if (strongSelf == nil)
            return;
    ...
    if (_hasDeleteButton)
    {
        MenuSheetButtonItemView *deleteItem = [[MenuSheetButtonItemView alloc] initWithTitle:TGLocalized(@"GroupInfo.SetGroupPhotoDelete") type:MenuSheetButtonTypeDestructive action:^
        {
            __strong TGMediaAvatarMenuMixin *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
    ...
    MenuSheetButtonItemView *cancelItem = [[MenuSheetButtonItemView alloc] initWithTitle:TGLocalized(@"Common.Cancel") type:MenuSheetButtonTypeCancel action:^
    {
        __strong TGMediaAvatarMenuMixin *strongSelf = weakSelf;
        if (strongSelf == nil)
            return;
