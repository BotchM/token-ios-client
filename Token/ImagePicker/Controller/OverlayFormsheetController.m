...
@interface OverlayFormsheetController ()
{
    UIControl *_dimView;
    UIView *_wrapperView;
    UIView *_contentView;
...
@implementation OverlayFormsheetController
...
- (instancetype)initWithContentController:(UIViewController *)viewController
{
    ...
    if (self != nil)
    {
        ...
        _wrapperView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, OverlayFormsheetControllerReferenceSize.width, OverlayFormsheetControllerReferenceSize.height)];
