...
@implementation CameraTimeCodeView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken, ^
        {
            ...
            CGContextSetFillColorWithColor(context, [CameraInterfaceAssets redColor].CGColor);
        ...
        _timeLabel.font = [CameraInterfaceAssets normalFontOfSize:21];
        _timeLabel.text = @"00:00:00";
        _timeLabel.textAlignment = NSTextAlignmentCenter;
        _timeLabel.textColor = [CameraInterfaceAssets normalColor];
