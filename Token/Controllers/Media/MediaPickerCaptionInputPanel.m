...
//@interface MediaPickerCaptionInputPanel () <HPGrowingTextViewDelegate>
//{
...
//
//    ModernConversationAssociatedInputPanel *_associatedPanel;
//    
...
@implementation MediaPickerCaptionInputPanel
...
//        {
//            NSString *placeholderText = TGLocalized(@"AddCaption");
...
//        _backgroundView.backgroundColor = [PhotoEditorInterfaceAssets toolbarTransparentBackgroundColor];
...
//        _placeholderLabel.text = TGLocalized(@"AddCaption");
...
//    
//    id<MediaPickerCaptionInputPanelDelegate> delegate = self.delegate;
...
//        return false;
//    
//    if (_inputField.text.length > MediaPickerCaptionInputPanelCaptionLimit)
//    {
//        [self shakeControls];
//        return false;
//    }
...
//        [Hacks applyCurrentKeyboardAutocorrectionVariant];
//    
...
//    if (animated)
//    {
//        [UIView animateWithDuration:0.3f delay:0.0f options:[ViewController preferredAnimationCurve] << 16 animations:frameChangeBlock completion:nil];
...
//    _counterLabel.text = [NSString stringWithFormat:@"%d", (int)(MediaPickerCaptionInputPanelCaptionLimit - textLength)];
//    
//    bool hidden = (text.length < MediaPickerCaptionInputPanelCaptionCounterThreshold);
...
//    }
//
//    bool highlighted = (textLength > MediaPickerCaptionInputPanelCaptionLimit);
...
//    }
//    
//    _counterLabel.hidden = ![self isFirstResponder] || textLength < MediaPickerCaptionInputPanelCaptionCounterThreshold;
//}
//
//- (void)shakeControls
//{
...
//    DispatchAfter(0.3, dispatch_get_main_queue(), ^
//    {
...
//    {
//        [self adjustForOrientation:UIInterfaceOrientationPortrait keyboardHeight:0 duration:0.2f animationCurve:[ViewController preferredAnimationCurve]];
//    }
//    
...
//    
//    id<MediaPickerCaptionInputPanelDelegate> delegate = (id<MediaPickerCaptionInputPanelDelegate>)self.delegate;
...
//{
//    [ModernConversationInputTextPanel replaceMention:mention inputField:_inputField];
//}
//
//- (void)replaceMention:(NSString *)mention username:(bool)username userId:(int32_t)userId {
//    [ModernConversationInputTextPanel replaceMention:mention inputField:_inputField username:username userId:userId];
//}
//
//- (void)replaceHashtag:(NSString *)hashtag
//{
//    [ModernConversationInputTextPanel replaceHashtag:hashtag inputField:_inputField];
//}
//
...
//    {
//        ModernConversationAssociatedInputPanel *currentPanel = _associatedPanel;
//        if (currentPanel != nil)
//        {
//            if (animated)
//            {
...
//            } else {
//                __weak MediaPickerCaptionInputPanel *weakSelf = self;
//                _associatedPanel.preferredHeightUpdated = ^
//                {
//                    __strong MediaPickerCaptionInputPanel *strongSelf = weakSelf;
//                    if (strongSelf != nil)
//                    {
