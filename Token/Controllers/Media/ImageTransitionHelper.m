#import "ImageTransitionHelper.h"
...
@interface ImageTransitionHelper ()
...
@implementation ImageTransitionHelper
...
{
    CGSize screenSize = [ViewController screenSizeForInterfaceOrientation:toInterfaceOrientation];
...
{
    [ViewController disableAutorotationFor:duration + 0.05];
    [ViewController disableUserInteractionFor:duration + 0.05];
...
//    {
//        UIImage *smallImage = ScaleImageToPixelSize(image, TGFitSize(CGSizeMake(300, 300), CGSizeMake(image.size.width * image.scale, image.size.height * image.scale)));
...
//    }
    ...
    CGSize screenSize = [ViewController screenSizeForInterfaceOrientation:interfaceOrientation];
