...
typedef enum {
    ModernCacheKeyspaceGlobalProperties = 1,
    ModernCacheKeyspaceLastUsageByPath = 2,
    ModernCacheKeyspacePathAndSizeByLastUsage = 3,
    ModernCacheKeyspaceLastUsageSortingValue = 4
} ModernCacheKeyspace;

typedef enum {
    ModernCacheGlobalPropertySize = 1
} ModernCacheGlobalProperty;

@interface ModernCache ()
{
    NSString *_path;
    SQueue *_queue;
    NSUInteger _maxSize;
...
//        int8_t keyspace = ModernCacheKeyspacePathAndSizeByLastUsage;
...
//    int8_t keyspace = ModernCacheKeyspaceGlobalProperties;
//    [keyData appendBytes:&keyspace length:1];
//    int32_t property = ModernCacheGlobalPropertySize;
...
//        int8_t keyspace = ModernCacheKeyspaceLastUsageByPath;
...
//    {
//        NSMutableData *keyData = [[NSMutableData alloc] init];
//        int8_t keyspace = ModernCacheKeyspaceLastUsageSortingValue;
//        [keyData appendBytes:&keyspace length:1];
...
//        keyspace = ModernCacheKeyspacePathAndSizeByLastUsage;
