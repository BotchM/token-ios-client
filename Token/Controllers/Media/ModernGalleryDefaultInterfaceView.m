...
@interface ModernGalleryDefaultInterfaceView ()
{
...
@implementation ModernGalleryDefaultInterfaceView
...
- (void)setTransitionOutProgress:(CGFloat)transitionOutProgress
{
    ...
    {
        if ([view conformsToProtocol:@protocol(ModernGalleryDefaultFooterView)])
        {
            id<ModernGalleryDefaultFooterView> footerView = (id<ModernGalleryDefaultFooterView>)view;
...
- (void)itemFocused:(id<ModernGalleryItem>)__unused item itemView:(ModernGalleryItemView *)__unused itemView
{
}
